...
void main() {
  ...
  // Calculate the dot product for diffuse lighting
  ...
  vec3 materialColor = vec3(0.0, 1.0, 0.0); // assuming red material
  v_color = materialColor * (diffuse + specular * 0.5); // color calculation
}
`;
...
void main() {
  outColor = vec4(v_color, 1.0); // Use the interpolated vertex color
}
`;
